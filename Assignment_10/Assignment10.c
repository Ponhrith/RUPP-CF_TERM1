...
int main(){
	...
	// User Enter Number 1- 10 to Pick The Choice
	printf("\nEnter choice: ");
	scanf("%d", &choice);
	...
	switch(choice)
{
	...
	case 9:
				...
				//long int count=0;
				count=0;
				// User Input The Hexadecimal Number
    ...
    case 10:
			...
			// User Input The Binary Number
			printf("Enter a Binary number To Convet it into Hexadecimal : ");
